...
Ke_s = fiber.core_ellipticity_coupling_matrix(
    gamma=gamma, wavelength=signal_wavelength)
...
Ke_p = fiber.core_ellipticity_coupling_matrix(
    gamma=gamma, wavelength=pump_wavelength)
Kb_p = fiber.birefringence_coupling_matrix(
...
total_energy = total_signal_power * signal_attenuation / \
    (hp * signal_freq) + total_pump_power * pump_attenuation / (hp * pump_freq)
