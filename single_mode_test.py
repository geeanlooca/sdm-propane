...
parser.add_argument("-P", "--power", default=500.0, type=float)
parser.add_argument("-L", "--fiber-length", default=1, type=float)
parser.add_argument("-d", "--dz", default=10, type=float)
...
plt.plot(z*1e-3, P_th * 1e3, marker='x', markevery=markevery, linestyle='none')
...
plt.plot(z*1e-3, 30 + 10 * np.log10(P_th), marker='x', markevery=markevery, linestyle='none')
plt.legend(fiber.mode_names(signal_wavelength), loc="upper right")
plt.xlabel("Position [km]")
...
plt.plot(z*1e-3, Pp_th * 1e3, marker='x', markevery=markevery, linestyle='none')
